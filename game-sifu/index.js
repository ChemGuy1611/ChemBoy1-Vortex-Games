...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1063"; //https://www.nexusmods.com/site/mods/350 Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Sifu";
...
function getExecutable(discoveryPath) {
  ...
  if (isCorrectExec(EXEC_XBOX)) {
    ...
    SAVE_TARGET = path.join(SAVE_PATH, USERID_FOLDER);
    return EXEC_XBOX;
  }
...
async function setup(discovery, api, gameSpec) {
  ...
  await vfs.ensureDirWritableAsync(path.join(CONFIG_TARGET));
  await vfs.ensureDirWritableAsync(path.join(SAVE_TARGET));
