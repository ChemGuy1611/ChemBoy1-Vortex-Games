...
| 6           | _(deleted/removed)_ | Removed by Nexus; never returned in active API responses |
...
strict subset — a file can only be _uploaded_ as `main`, `optional`, or `miscellaneous`
