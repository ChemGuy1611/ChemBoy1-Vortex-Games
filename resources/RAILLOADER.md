...
Railloader is the second mod loader used by _Railroader_, alongside Unity Mod Manager. Most of the
...
- **The loader binary currently has no reachable download source.** Mod support is fully
  deliverable; automatic acquisition of the loader itself is not. See _Distribution_ below.
