...
function setMyValue(value) {
    return { type: SET_MY_VALUE, payload: value };
}
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    More,
                    { id: "my-setting-more", name: "My Setting" },
...
function setUe4ssLoadOrder(loadOrder) {
    return { type: SET_UE4SS_LOAD_ORDER, payload: loadOrder };
}
