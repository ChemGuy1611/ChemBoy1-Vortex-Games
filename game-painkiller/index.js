...
const GAME_ID = "painkiller";
const STEAMAPP_ID = "2300120";
const STEAMAPP_ID_DEMO = "4047990";
const EPICAPP_ID = null;
const GOGAPP_ID = null;
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, STEAMAPP_ID_DEMO]; // UPDATE THIS WITH ALL VALID IDs
const GAME_NAME = "Painkiller";
const GAME_NAME_SHORT = "Painkiller";
const EXEC = "Painkiller.exe";
const EXEC_EPIC = EXEC;
const EXEC_GOG = EXEC;
const EXEC_DEMO = EXEC;

//Unreal Engine specific
const EPIC_CODE_NAME = "Painkiller";
