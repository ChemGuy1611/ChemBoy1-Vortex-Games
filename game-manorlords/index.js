...
function applyGame(context, gameSpec) {
  ...
  //Priorities renumbered around UEMI's fixed ue4-pak-installer slot (prio 25, external). MLUE4SS_ID is a
  //pre-existing game-specific installer preserved at its old prio 20. UE4SSCOMBO_ID/LOGICMODS_ID must run
  //BEFORE UEMI's generic "any .pak present" test or their archives get intercepted by it - kept tight,
  //consecutive, immediately below 25, same as game-trepang2/game-witchfire. Everything else doesn't test
  //for .pak, so stays above 25 at template's original spacing.
