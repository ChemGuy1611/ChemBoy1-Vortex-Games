...
| --- | --- | --- |
| Config File Mods | a config file such as `engine.ini` or `input.ini` | - |
| Root / Game Folder Mods | a top-level folder such as `Indiana` | the game folder itself (no subfolder) |
...
- Recognised by a top-level folder matching any of: `Indiana`.
