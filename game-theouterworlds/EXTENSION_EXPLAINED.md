...
| Executable | `TheOuterWorlds.exe` |
| Executable (Xbox) | `gamelaunchhelper.exe` |
| Executable (GOG) | `TheOuterWorlds.exe` |
| Executable (Demo) | `TheOuterWorlds.exe` |
...
| `IO_STORE` | `false` | true if the Paks folder contains .ucas and .utoc files - old file's fileExt was ".pak" only |
...
| --- | --- | --- | --- |
| UE4SS Script-LogicMod Combo | `theouterworlds-ue4sscombo` | high | `{gamePath}` |
...
| UE4SS | `theouterworlds-ue4ss` | 56 | `?` |
| Config (Local AppData) | `theouterworlds-config` | 62 | `?` |
| Saves (Local AppData) | `theouterworlds-save` | 64 | `?` |
...
| `theouterworlds-root` | 39 |
| `theouterworlds-config` | 41 |
| `theouterworlds-save` | 43 |
| `theouterworlds-binaries` | 49 |
