# Notes for Mod Authors - Ninja Gaiden 2 Black

Packaging rules for Ninja Gaiden 2 Black mods, so Vortex installs them to the right place.
...
Installs to: `NINJAGAIDEN2BLACK\Content\Paks\LogicMods\LogicMods`
...
Installs to: `NINJAGAIDEN2BLACK\Content\Paks\~mods`
...
- Recognised by a top-level folder matching any of: `NINJAGAIDEN2BLACK`.
...
Recognised when the archive contains a file or folder named `d3d9.dll`.

## Mlmod

Recognised when the archive contains a file or folder named `mods`.
