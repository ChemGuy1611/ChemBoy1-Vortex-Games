...
const GAME_ID = "lostsoulaside";
const STEAMAPP_ID = "3378960";
const STEAMAPP_ID_DEMO = "3857710";
const EPICAPP_ID = "8fe50ab7cb6b4ec586c8558036ecbbba";
const GOGAPP_ID = null;
const GAME_NAME = "Lost Soul Aside";
const GAME_NAME_SHORT = "Lost Soul Aside";
const EXEC = "LostSoulAside.exe";
const EXEC_DEMO = "LostSoulAsideDemo.exe";
//Unreal Engine specific
const EPIC_CODE_NAME = "Projectlsa";
...
//config and save
const DATA_FOLDER = "LostSoulAside";
const CONFIG_FOLDERNAME = "WindowsNoEditor";
const CONFIG_LOC = "USERPROFILE\\Saved Games";
const SAVE_LOC = "USERPROFILE\\Saved Games";
const CONFIGMOD_LOCATION = USER_HOME;
...
const SHIPPING_EXE_STEAM = path.join(
  BINARIES_PATH,
  `${EPIC_CODE_NAME}-${EXEC_FOLDER_NAME}Steam-Shipping.exe`,
);
const SHIPPING_EXE_EPIC = path.join(
  BINARIES_PATH,
  `${EPIC_CODE_NAME}-${EXEC_FOLDER_NAME}EOS-Shipping.exe`,
);
const SHIPPING_EXE_STEAMDEMO = path.join(
  BINARIES_PATH,
  `${EPIC_CODE_NAME}-${EXEC_FOLDER_NAME}SteamDemo-Shipping.exe`,
);
...
const SAVE_FOLDER = path.join(SAVEMOD_LOCATION, "Saved Games", DATA_FOLDER, "Saved", "SaveGames");
let USERID_FOLDER = "";
...
const SIGBYPASS_PAGE_NO = 3; //set if there is sigbypass Nexus page
const SIGBYPASS_FILE_NO = 3;

const MOD_PATH_DEFAULT = PAK_PATH;
const MODTYPE_FOLDERS = [LOGICMODS_PATH, SCRIPTS_PATH, PAK_PATH];

//Filled in from data above
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1415"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Lost_Soul_Aside";
...
function applyGame(context, gameSpec) {
  ...
  if (SIGBYPASS_PAGE_NO !== 0) {
    //only enable modtype if there is a sigbypass Nexus page
    context.registerModType(
      SIGBYPASS_ID,
      60,
      (gameId) => {
  ...
  if (SIGBYPASS_PAGE_NO !== 0) {
    //only enable installer if there is a sigbypass Nexus page
