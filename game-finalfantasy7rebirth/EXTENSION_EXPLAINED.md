...
| Executable (GOG) | `ff7rebirth.exe` |
| Executable (Demo) | `ff7rebirth.exe` |
...
| UE4SS LogicMods (Blueprint) | `finalfantasy7rebirth-logicmods` | high | `{gamePath}/End/Content/Paks` |
| Paks (no "~mods") | `finalfantasy7rebirth-pakalt` | high | `{gamePath}/End/Content/Paks` |
...
| UE4SS | `finalfantasy7rebirth-ue4ss` | 56 | `?` |
| Config (Documents) | `finalfantasy7rebirth-config` | 62 | `?` |
| Saves (Documents) | `finalfantasy7rebirth-save` | 64 | `?` |
...
| `finalfantasy7rebirth-binaries` | 49 |
