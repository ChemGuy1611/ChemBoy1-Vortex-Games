...
const EPIC_CODE_NAME = "detnoir";
const EXEC_FOLDER_NAME = "Win64";
const GAME_NAME = "Nobody Wants to Die";
const GAME_NAME_SHORT = "Nobody Wants to Die";
const EXEC = "detnoir.exe";
...
function applyGame(context, gameSpec) {
  ...
  //context.registerInstaller(`${GAME_ID}-save`, 55, testSave, installSave);
