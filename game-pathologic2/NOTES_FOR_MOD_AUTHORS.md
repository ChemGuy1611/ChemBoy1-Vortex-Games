# Notes for Mod Authors - Pathologic 2

Packaging rules for Pathologic 2 mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `Pathologic_Data` or `MonoBleedingEdge` in the archive.
