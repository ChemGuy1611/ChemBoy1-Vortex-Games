...
const UPLAYAPP_ID = "40";
const STEAMAPP_ID = "201870";
const GAME_ID = "assassinscreedrevelations";
const GAME_NAME = "Assassin's Creed Revelations";
const GAME_NAME_SHORT = "AC Revelations";
const EXEC = "ACRSP.exe";
const ATK_ID = `${GAME_ID}-atk`;
const ATK_EXEC = "anviltoolkit.exe";

const EXTENSION_URL = "https://www.nexusmods.com/site/mods/990"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Assassin%27s_Creed%3A_Revelations";
