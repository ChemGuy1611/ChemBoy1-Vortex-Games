# Notes for Mod Authors - Dragon Ball: Sparking! Zero

Packaging rules for Dragon Ball: Sparking! Zero mods, so Vortex installs them to the right place.
...
Installs to: `SparkingZERO\Content\Paks\LogicMods\LogicMods`
...
Installs to: `SparkingZERO\Binaries\Win64\ue4ss\Mods`
