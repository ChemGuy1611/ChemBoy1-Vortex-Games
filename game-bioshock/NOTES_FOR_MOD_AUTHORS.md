# Notes for Mod Authors - BioShock Remastered

Packaging rules for BioShock Remastered mods, so Vortex installs them to the right place.
...
- Recognised by any file named `BioshockHD.exe` or `Bioshock.exe`.
