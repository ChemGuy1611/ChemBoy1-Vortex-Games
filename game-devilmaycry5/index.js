...
const STEAMAPP_ID = "601150"; // https://steamdb.info/app/601150/
...
const FLUFFY_FOLDER_DEMO = ""; //!set as "" if no demo
const ROOT_FILES = [
  "nvngx_dlss.dll",
  "dstoragecore.dll",
  "dstorage.dll",
...
const ROOT_EXTS = [".exe"];
const REF_PAGE_NO = 2760;
const REF_FILE_NO = 12508;
const REF_DOMAIN = GAME_ID;
const CONFIG_PATH = ".";
const CONFIG_FILE = "dmc5config.ini";
