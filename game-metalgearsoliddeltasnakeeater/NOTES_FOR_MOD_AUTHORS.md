# Notes for Mod Authors - Metal Gear Solid Delta: Snake Eater

Packaging rules for Metal Gear Solid Delta: Snake Eater mods, so Vortex installs them to the right place.
...
Installs to: `MGSDelta\Content\Paks\LogicMods\LogicMods`
...
Installs to: `MGSDelta\Binaries\Win64\ue4ss\Mods`
