...
const CONFIG_PATH = path.join(LOCALAPPDATA, DATA_FOLDER, "Saved", "Config", "Windows");
const CONFIG_FILES = [
  "engine.ini",
  "game.ini",
...
const UE4SS_PAGE_NO = 0; //no nexus page for UE4SS currently
