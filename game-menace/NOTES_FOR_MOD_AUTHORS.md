# Notes for Mod Authors - MENACE

Packaging rules for MENACE mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `Menace_Data` or `Menace_Data` in the archive.
