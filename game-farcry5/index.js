...
const GAME_ID = "farcry5";
const STEAMAPP_ID = "552520";
const UPLAYAPP_ID = "1803"; //4311
const EPICAPP_ID = "Coriander";
const GAME_NAME = "Far Cry 5";
const GAME_NAME_SHORT = "FC5";

const BIN_PATH = "bin";
const DATA_PATH = path.join("data_final", "pc");
const EXEC_NAME = "FarCry5.exe";
const FC = "fc5";
const MI_EXEC = "FC5ModInstaller.exe";
const MIMOD_FOLDER = "ModifiedFilesFC5";

const DATA_FOLDER = "Far Cry 5";
const XML_PAGE_NO = 0;
const XML_FILE_NO = 0;
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1476"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Far_Cry_5";
    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog(
            ...
            {
              text:
                "This extension has automatically downloaded and installed the FC Mod Installer application. This can be used to install mods from the database site linked below.\n" +
                "\n" +
...
function applyGame(context, gameSpec) {
  ...
  context.registerInstaller(MIMODA3_ID, 33, testMiModA3, installMiModA3);
