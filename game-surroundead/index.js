...
const GAME_ID = "surroundead"; //same as Nexus domain
const STEAMAPP_ID = "1645820"; //from steamdb.info
...
const GAME_NAME = "SurrounDead";
const GAME_NAME_SHORT = "SurrounDead"; //Try for 8-10 characters
const EPIC_CODE_NAME = "SurrounDead"; //Folder in root
...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/SurrounDead";
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1637"; //Nexus link to this extension. Used for links
const spec = {
  game: {
    id: GAME_ID,
    name: GAME_NAME,
