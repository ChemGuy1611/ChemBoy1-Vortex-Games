# Notes for Mod Authors - Disco Elysium

Packaging rules for Disco Elysium mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `disco_Data` or `Disco Elysium_Data` in the archive.
...
Installs to: `disco_Data\Managed`
