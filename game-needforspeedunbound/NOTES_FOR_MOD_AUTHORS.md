# Notes for Mod Authors - Need for Speed Unbound

Packaging rules for Need for Speed Unbound mods, so Vortex installs them to the right place.
...
| Frosty Mods | a `.fbmod` file | `FrostyModManager\Mods\NeedForSpeedUnbound` |
...
Installs to: `FrostyModManager\Mods\NeedForSpeedUnbound`
