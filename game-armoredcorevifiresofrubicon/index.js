...
const GAME_ID = "armoredcorevifiresofrubicon";
const STEAMAPP_ID = "1888160"; // https://steamdb.info/app/1888160/
...
const GAME_NAME = "ARMORED CORE VI FIRES OF RUBICON";
const GAME_NAME_SHORT = "ARMORED CORE VI";
...
const ME3_ID = `${GAME_ID}-me3`;
const ME3_NAME = "Mod Engine 3";
const ME3_PATH = BINARIES_PATH;
const ME3_FILE = 'XXX.dll';
const ME3_PAGE_NO = 0;
const ME3_FILE_NO = 0;
const ME3_DOMAIN = GAME_ID;
const ME3_URL = `https://github.com/garyttierney/me3/releases/latest/download/me3-windows-amd64.zip`; //if not on Nexus
