# Resident Evil 6 — Vortex Extension Explained
...
| Property | Value |
| --- | --- |
| Game ID | `residentevil6` |
| Executable | `BH6.exe` |
| Executable (Xbox) | `gamelaunchhelper.exe` |
| Extension Page | [https://www.nexusmods.com/site/mods/2029](https://www.nexusmods.com/site/mods/2029) |
| PCGamingWiki | [https://www.pcgamingwiki.com/wiki/Resident_Evil_6](https://www.pcgamingwiki.com/wiki/Resident_Evil_6) |
...
| --- | --- | --- | --- |
| Root Folder | `residentevil6-root` | high | `{gamePath}` |
...
| --- | --- |
| `residentevil6-root` | 27 |
| `residentevil6-fallback` | 49 |

## Registered Tools

These tools appear in Vortex's Tools panel when this game is active:

- **Custom Launch** (`BH6.exe`)
