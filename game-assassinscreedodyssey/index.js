...
const EPICAPP_ID = "Clary";
const GAME_ID = "assassinscreedodyssey";
const GAME_NAME = "Assassin's Creed Odyssey";
    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog(
            ...
            {
              text:
                "Some of the most popular mods for AC Odyssey require a software called Resorep.\n" +
