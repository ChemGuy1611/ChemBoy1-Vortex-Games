...
const STEAM_EXEC = path.join(
  EPIC_CODE_NAME,
  "Binaries",
  STEAM_EXEC_FOLDER,
  `${EPIC_CODE_NAME}-${STEAM_EXEC_FOLDER}-Shipping.exe`,
);
const GOG_EXEC = path.join(
  EPIC_CODE_NAME,
  "Binaries",
  GOG_EXEC_FOLDER,
  `${EPIC_CODE_NAME}-${GOG_EXEC_FOLDER}-Shipping.exe`,
);
const EPIC_EXEC = path.join(
  EPIC_CODE_NAME,
  "Binaries",
  EPIC_EXEC_FOLDER,
  `${EPIC_CODE_NAME}-${EPIC_EXEC_FOLDER}-Shipping.exe`,
); //Need to confirm for Epic
const XBOX_EXEC = path.join(
  EPIC_CODE_NAME,
  "Binaries",
  XBOX_EXEC_FOLDER,
  `${EPIC_CODE_NAME}-${XBOX_EXEC_FOLDER}-Shipping.exe`,
);
...
const MODTYPE_FOLDERS = [MOD_PATH, path.join(LOGICMODS_PATH, LOGICMODS_FOLDER)];
