# Notes for Mod Authors - WH40K Boltgun

Packaging rules for WH40K Boltgun mods, so Vortex installs them to the right place.
...
Installs to: `Boltgun\Content\Paks\LogicMods`
...
Installs to: `Boltgun\Binaries\Win64`
...
Installs to: `Boltgun\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `Boltgun`.
