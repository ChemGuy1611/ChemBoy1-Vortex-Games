# Notes for Mod Authors - Silent Hill 2 Remake

Packaging rules for Silent Hill 2 Remake mods, so Vortex installs them to the right place.
...
Installs to: `SHProto\Content\Paks\LogicMods\LogicMods`
...
Installs to: `SHProto\Content\Paks\~mods`
...
Installs to: `SHProto\Binaries\Win64`
...
Installs to: `SHProto\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `SHProto`.
