# Notes for Mod Authors - WUCHANG: Fallen Feathers

Packaging rules for WUCHANG: Fallen Feathers mods, so Vortex installs them to the right place.
...
Installs to: `Project_Plague\Content\Paks\LogicMods\LogicMods`
...
Installs to: `Project_Plague\Content\Paks\~mods`
...
- Recognised by a top-level folder matching any of: `Project_Plague`.
