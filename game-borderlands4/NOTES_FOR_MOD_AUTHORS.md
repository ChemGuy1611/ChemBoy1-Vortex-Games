# Notes for Mod Authors - Borderlands 4

Packaging rules for Borderlands 4 mods, so Vortex installs them to the right place.
...
Installs to: `OakGame\Content\Paks\LogicMods\LogicMods`
...
Installs to: `OakGame\Binaries\Win64\ue4ss\Mods`
...
- Recognised by any file with extension `.sav` or `.yaml`.
