    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog(
            ...
            {
              text:
                "Some of the most popular mods for AC Origins require a software called Resorep.\n" +
            ...
            [
              { label: "Continue", action: () => dismiss() },
              {
                ...
                action: () => {
                  util
                    .opn("https://www.undertow.club/downloads/resorep.1254/")
                    .catch((err) => undefined);
                  dismiss();
                },
              },
