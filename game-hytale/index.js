...
const GAME_ID = "hytale";
const STEAMAPP_ID = null; //not on any game store
...
const MOD_NAME = "Mod";
const MOD_PATH = path.join('UserData', 'Mods');
const MOD_EXTS = ['.jar'];
...
const CONFIG_PATH = path.join('UserData');
const CONFIG_EXTS = [".XXX"];
const CONFIG_FILES = ["settings.json"];

const SAVE_ID = `${GAME_ID}-save`;
const SAVE_NAME = "Save";
const SAVE_PATH = path.join('UserData', 'Saves');
const SAVE_EXTS = [".XXX"];
