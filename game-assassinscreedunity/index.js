...
const UPLAYAPP_ID = "720"; //Ubisoft Connect App ID — from SOFTWARE\WOW6432Node\Ubisoft\Launcher\Installs\
const STEAMAPP_ID = "289650"; //https://steamdb.info/app/XXX/
const EPICAPP_ID = "Amberjack"; //Epic catalog item — Ubisoft games are usually installed through Ubisoft Connect instead
...
const hasFixes = true; //true if game has a community "fixes" DLL package
