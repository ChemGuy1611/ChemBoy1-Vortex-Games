# Notes for Mod Authors - AC Unity

Packaging rules for AC Unity mods, so Vortex installs them to the right place.
...
| Dlcfolder | a file or folder named one of: `dlc_10` or `dlc_11` | the game folder itself (no subfolder) |
...
| Fixes | a file or folder named one of: `version.dll` or `ACUFixes` | the game folder itself (no subfolder) |
...
Recognised when the archive contains a file or folder named one of: `dlc_10` or `dlc_11`.
...
Recognised when the archive contains a file or folder named one of: `version.dll` or `ACUFixes`.
