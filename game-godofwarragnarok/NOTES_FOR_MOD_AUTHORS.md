...
| Patchfolder | a file or folder named `patch` | - |
| Execsub | a file or folder named one of: `ActivityFeed`, `cinematics`, `dc`, `languages`, `sound` or `wad` | - |
| Pack | a file with one of these extensions: `.texpack` or `.lodpack` | - |
| Luamod | a file or folder named `int9` and a file with one of these extensions: `.lua` | - |
| Save | - | - |
