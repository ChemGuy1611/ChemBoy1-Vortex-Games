# Notes for Mod Authors - Lobotomy Corporation

Packaging rules for Lobotomy Corporation mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `LobotomyCorp_Data` in the archive.
