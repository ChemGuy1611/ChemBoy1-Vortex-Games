# Notes for Mod Authors - Dishonored 2

Packaging rules for Dishonored 2 mods, so Vortex installs them to the right place.
...
- Recognised by any file named `dishonored2config.cfg`.

Installs to: `USERHOME\Saved Games\Arkane Studios\Dishonored2\base`
