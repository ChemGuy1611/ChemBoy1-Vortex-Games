...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Look_Outside";
    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog(
            ...
            {
              text:
                `After installing a js plugin mods with Vortex, you must update the plugins.js file manually.\n` +
