...
const GAME_ID = "runefactoryguardiansofazuma";
const STEAMAPP_ID = "2864560";
const STEAMAPP_ID_DEMO = null;
const EPICAPP_ID = null;
const GOGAPP_ID = null;
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID]; // UPDATE THIS WITH ALL VALID IDs
const GAME_NAME = "Rune Factory: Guardians of Azuma";
const GAME_NAME_SHORT = "Rune Factory: GoA";
const EXEC = "Game.exe";
...
//config and save
const DATA_FOLDER = "Rune Factory Guardians of Azuma";
