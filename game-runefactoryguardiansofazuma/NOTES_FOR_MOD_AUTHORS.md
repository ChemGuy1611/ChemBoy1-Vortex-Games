# Notes for Mod Authors - Rune Factory: Guardians of Azuma

Packaging rules for Rune Factory: Guardians of Azuma mods, so Vortex installs them to the right place.
...
- Installed to `CONFIGMOD_LOCATION\Rune Factory Guardians of Azuma\Saved\Config\Windows`.

Installs to: `CONFIGMOD_LOCATION\Rune Factory Guardians of Azuma\Saved\Config\Windows`
