# Notes for Mod Authors - Assassin's Creed Shadows

Packaging rules for Assassin's Creed Shadows mods, so Vortex installs them to the right place.
...
| Forger Patch Textures | a `.dds` file | `ForgerPatches` |
...
## Forger Patch Textures

Loose textures applied as a Forger patch.

**Requirements:**

- Recognised by any file with the `.dds` extension.

Installs to: `ForgerPatches`
...
- Recognised by a folder named `dlc_10`, `dlc_26`, `dlc_28` or `dlc_29` in the archive.
