...
const GAME_ID = "titanquest2";
const STEAMAPP_ID = "1154030";
const STEAMAPP_ID_DEMO = null;
const EPICAPP_ID = "84f9595192cb492dbf122e014a6b33f4"; // egdata.app
const GOGAPP_ID = null;
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, EPICAPP_ID]; // UPDATE THIS WITH ALL VALID IDs
const GAME_NAME = "Titan Quest 2";
const GAME_NAME_SHORT = "Titan Quest 2";
const EXEC = "TQ2.exe";
const EXEC_EPIC = EXEC;
//Unreal Engine specific
const EPIC_CODE_NAME = "TQ2";
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1430"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Titan_Quest_II";
