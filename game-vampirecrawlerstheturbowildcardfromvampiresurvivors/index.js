...
const GAME_ID = "vampirecrawlerstheturbowildcardfromvampiresurvivors";
const STEAMAPP_ID = "3265700"; // https://steamdb.info/app/3265700/
const STEAMAPP_ID_DEMO = "4329470"; // https://steamdb.info/app/4329470/
const EPICAPP_ID = null;
const GOGAPP_ID = null;
const XBOXAPP_ID = "poncle.VampireCrawlers"; // https://apps.microsoft.com/detail/9NMPVJ7TCFD0
const XBOXEXECNAME = "Game";
const XBOX_PUB_ID = "XXX"; //string after "ID_"
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, XBOXAPP_ID, STEAMAPP_ID_DEMO]; // UPDATE THIS WITH ALL VALID IDs

const GAME_NAME = "Vampire Crawlers: The Turbo Wildcard from Vampire Survivors";
const GAME_NAME_SHORT = "Vampire Crawlers";
const GAME_STRING = "Vampire Crawlers"; //string for exe and data folder (seem to always match)
...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Vampire_Crawlers%3A_The_Turbo_Wildcard_from_Vampire_Survivors";
...
const DEV_REGSTRING = "Nosebleed Interactive"; //developer name
const GAME_REGSTRING = "Vampire Crawlers"; //game name
