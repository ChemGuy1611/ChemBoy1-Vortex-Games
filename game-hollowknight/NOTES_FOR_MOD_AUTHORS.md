# Notes for Mod Authors - Hollow Knight

Packaging rules for Hollow Knight mods, so Vortex installs them to the right place.
...
Recognised when the archive contains a file or folder named `hollow_knight_Data`.
...
Installs to: `hollow_knight_Data\Managed`
...
Installs to: `hollow_knight_Data`
