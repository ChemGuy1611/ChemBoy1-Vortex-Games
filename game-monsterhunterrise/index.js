...
const STEAMAPP_ID = "1446780"; // https://steamdb.info/app/1446780/
const STEAMAPP_ID_DEMO = "1836450"; // https://steamdb.info/app/1836450/
...
const EXEC = "MonsterHunterRise.exe";
const EXEC_DEMO = "MHRiseSunbreakDemo.exe";
...
const ROOT_EXTS = [".exe"];
const REF_PAGE_NO = 26;
const REF_FILE_NO = 14689;
