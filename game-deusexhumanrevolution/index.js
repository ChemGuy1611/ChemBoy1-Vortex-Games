...
const SAVE_PATH_STEAM_LEGACY = path.join(
  "STEAM_FOLDER",
  "userdata",
  "USER_ID",
  STEAMAPP_ID_LEGACY,
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1468"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Deus_Ex%3A_Human_Revolution";
...
function applyGame(context, gameSpec) {
  ...
  context.registerInstaller(PATCHER_ID, 27, testPatcher, (files, temp) =>
    installPatcher(files, temp, context.api),
  );
