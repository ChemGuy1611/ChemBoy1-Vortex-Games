# Notes for Mod Authors - Keeper

Packaging rules for Keeper mods, so Vortex installs them to the right place.
...
Installs to: `PaganIdol\Content\Paks\LogicMods\LogicMods`
...
Installs to: `PaganIdol\Content\Paks\~mods`
...
- Recognised by a top-level folder matching any of: `PaganIdol`.
