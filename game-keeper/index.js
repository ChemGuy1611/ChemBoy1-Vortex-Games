...
const GAME_ID = "keeper"; //same as Nexus domain
...
const GAME_NAME_SHORT = "Keeper"; //Try for 8-10 characters
const EXEC_DEFAULT = "Keeper.exe";
const EXEC_EPIC = EXEC_DEFAULT;
const EXEC_GOG = EXEC_DEFAULT;
//Unreal Engine specific
const EPIC_CODE_NAME = "PaganIdol";
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1504"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Keeper";
...
async function requiresLauncher(gamePath, store) {
  ...
  //*
  if (store === "epic" && gameFinderQuery?.epic !== undefined) {
    return Promise.resolve({
      launcher: "epic",
      addInfo: {
        appId: EPICAPP_ID,
  ...
  context.registerModType(
    ...
    (gameId) => {
      ...
      return (
        gameId === GAME_ID &&
        CHECK_DATA === true &&
        (GAME_VERSION === "steam" || GAME_VERSION === "epic")
      );
    },
