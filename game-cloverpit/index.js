...
const TS_COMMUNITY = "clover-pit"; //https://thunderstore.io/c/clover-pit/
...
const GAME_STRING = "CloverPit"; //string for exe and data folder (seem to always match)
...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/CloverPit";
const STEAMDB_URL = `https://steamdb.info/app/${STEAMAPP_ID}/`;
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1496"; //Nexus link to this extension. Used for links
...
const SAVE_FOLDERNAME = "GameData"; //not LOCALLOW - saves are stored inside the game's own install folder, see SAVE_PATH_DEFAULT override below
...
let recommendedLoader = ""; // bep/mel - If loaderChoice false, this determines downloaded loader. Otherwise shows as "(Recommended)" in selector.
...
//real save location is relative to the game's own install folder, not LOCALLOW - joined with
//GAME_PATH fresh at click time by the "Open Save Folder" action below, not here
const SAVE_PATH_DEFAULT = path.join("SaveData", SAVE_FOLDERNAME);
...
function applyGame(context, gameSpec) {
  ...
  if (SAVE_FOLDERNAME !== "XXX") {
    ...
    context.registerAction(
      ...
      "Open Save Folder",
      async () => {
        //save is inside the game's own install folder, not an OS user-data folder - recompute
        //GAME_PATH fresh, same as "Open Data Folder" above
        GAME_PATH = getDiscoveryPath(context.api);
