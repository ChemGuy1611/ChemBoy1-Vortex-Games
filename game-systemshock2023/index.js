...
const GAME_ID = "systemshock2023"; //same as Nexus domain
const STEAMAPP_ID = "482400"; //from steamdb.info
const STEAMAPP_ID_DEMO = null; //no demo
const EPICAPP_ID = "1d703aedb468494681ed9e5b657dca00"; //from egdata.app
const GOGAPP_ID = "1439637285"; // from gogdb.org
...
const GAME_NAME_SHORT = "System Shock"; //Try for 8-10 characters
const EPIC_CODE_NAME = "SystemShock"; //Folder in root
