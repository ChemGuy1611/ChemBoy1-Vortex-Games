...
const PCGAMINGWIKI_URL =
  "https://www.pcgamingwiki.com/wiki/Uncharted%3A_Legacy_of_Thieves_Collection";
...
function installPsarc(files) {
  const modFile = files.find(
    (file) => path.basename(file).toLowerCase() === PSARC_FOLDER.toLowerCase(),
  );
