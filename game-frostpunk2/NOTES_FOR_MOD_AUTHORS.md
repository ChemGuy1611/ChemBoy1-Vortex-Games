# Notes for Mod Authors - Frostpunk 2

Packaging rules for Frostpunk 2 mods, so Vortex installs them to the right place.
...
Installs to: `Frostpunk2\Content\Paks\LogicMods\LogicMods`
...
Installs to: `Frostpunk2\Content\Paks\~mods`
...
- Recognised by a top-level folder matching any of: `Frostpunk2`.
...
- Recognised by any file with extension `.profile`.
