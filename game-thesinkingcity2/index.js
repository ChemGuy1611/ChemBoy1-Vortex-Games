/*////////////////////////////////////////////////
Name: The Sinking City 2 Vortex Extension
...
const GAME_ID = "thesinkingcity2"; //same as Nexus domain
const STEAMAPP_ID = "2825860"; // https://steamdb.info/app/2825860/
const STEAMAPP_ID_DEMO = null; //VERIFY if the EPIC_CODE_NAME and EXEC_DEMO match Steam full game
const EPICAPP_ID = "b428ed1a4519414faa04ba26ee058058"; // https://store.epicgames.com/en-US/p/the-sinking-city-2-72d2fd
const GOGAPP_ID = "1653226562"; // https://www.gogdb.org/product/1653226562
...
const GAME_NAME = "The Sinking City 2";
const GAME_NAME_SHORT = "The Sinking City 2"; //Try for 8-10 characters
const EPIC_CODE_NAME = "PlayGround"; //Folder in root
const EXEC_NAME = "TheSinkingCity2.exe"; //This is true ~80% of the time. Change if different
const PARAMETERS_STRING = ""; //launch arguments to pass when launching the game
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/The_Sinking_City_2";
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/2207"; //Nexus link to this extension. Used for links
...
const writeEngineVersion = true; //toggle to write ENGINE_VERSION into UE4SS-settings.ini (EngineVersionOverride) on deploy, when UE4SS is installed
...
//UE specific
const ENGINE_VERSION = "5.8.0.0"; //Unreal Engine version. usually '4.27.2.0' or '5.X.X.0'. Written to UE4SS-settings.ini if writeEngineVersion is enabled
...
//config and save
const DATA_FOLDER = "TSC2"; //almost always matches.
...
//This is true ~80% of the time. Change if different
const EXEC_EPIC = EXEC; //change these 3 if different
const EXEC_GOG = EXEC;
const EXEC_DEMO = EXEC;
let SHIPPING_EXE = EXEC;
