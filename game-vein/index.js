...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/w/index.php?search=vein&title=Special%3ASearch";
...
let SHIPPING_EXE = path.join(BINARIES_PATH, `${SHIPEXE_PROJECTNAME}-${EXEC_FOLDER_DEFAULT}${SHIPEXE_STRING_DEFAULT}-Test.exe`); //CUSTOMIZED
