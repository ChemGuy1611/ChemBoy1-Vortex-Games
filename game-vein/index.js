...
const GAME_ID = "vein"; //same as Nexus domain
const STEAMAPP_ID = "1857950"; //from steamdb.info
...
const GAME_NAME = "VEIN";
const GAME_NAME_SHORT = GAME_NAME; //Try for 8-10 characters
const EPIC_CODE_NAME = "Vein"; //Folder in root
...
const PCGAMINGWIKI_URL =
  "https://www.pcgamingwiki.com/w/index.php?search=vein&title=Special%3ASearch";
...
let SHIPPING_EXE = path.join(
  BINARIES_PATH,
  `${SHIPEXE_PROJECTNAME}-${EXEC_FOLDER_DEFAULT}${SHIPEXE_STRING_DEFAULT}-Test.exe`,
); //CUSTOMIZED
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1625"; //Nexus link to this extension. Used for links
const spec = {
  game: {
    id: GAME_ID,
    name: GAME_NAME,
        ...
        action: (dismiss) => {
          api.showDialog(
            ...
            MESSAGE,
            {
              text:
                `\n` +
                `In order to use certain mod types, the game, staging folder, and user folder (typically on C Drive) must all be on the same drive partition.\n` +
