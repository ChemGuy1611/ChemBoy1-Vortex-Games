# Notes for Mod Authors - Far Cry 3

Packaging rules for Far Cry 3 mods, so Vortex installs them to the right place.
...
Recognised when the archive contains a file or folder named `readme - ziggy's mod.txt`.
