# Notes for Mod Authors - template-unitymelonloaderbepinex-hybrid (template)

Packaging rules for template-unitymelonloaderbepinex-hybrid (template) mods, so Vortex installs them to the right place.
