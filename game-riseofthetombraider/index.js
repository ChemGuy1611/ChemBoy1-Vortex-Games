...
const XBOXAPP_ID = "39C668CD.RiseoftheTombRaider"; //!audit-skip: store-id - there is an xbox version, but it will never be moddable because it is a protected, encrypted WindowsApps package
    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog(
            ...
            {
              text:
                "The ROTTR Mod Manager tool downloaded by this extension requires setup.\n" +
