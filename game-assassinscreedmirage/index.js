    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog('question', 'Action required', {
            text: 'Some of the most popular mods for AC Mirage require a software called Forger Patch Manager.\n'
...
function applyGame(context, gameSpec) {
  ...
  context.registerInstaller('assassinscreedmirage-forger', 35, forgerTestSupportedContent, forgerInstallContent);
}
