# Notes for Mod Authors - Witchfire

Packaging rules for Witchfire mods, so Vortex installs them to the right place.
...
Installs to: `Witchfire\Content\Paks\LogicMods`
...
Installs to: `Witchfire\Binaries\Win64\ue4ss\Mods`
