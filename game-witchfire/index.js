...
const GAME_ID = "witchfire"; //same as Nexus domain
const STEAMAPP_ID = "3156770"; //from steamdb.info
const STEAMAPP_ID_DEMO = null; //no demo
const EPICAPP_ID = "8764f82381f5436f99e97172df06af35"; //from egdata.app
const GOGAPP_ID = null; //not on GOG
const XBOXAPP_ID = null; //not on Xbox
const XBOXEXECNAME = null; //not on Xbox
...
const GAME_NAME_SHORT = "Witchfire"; //Try for 8-10 characters
const EPIC_CODE_NAME = "Witchfire"; //Folder in root
...
//Retag pak mods off UEMI's global sortable modtype onto this extension's own - see plan/CHANGELOG:
