# Notes for Mod Authors - STORY OF SEASONS: Grand Bazaar

Packaging rules for STORY OF SEASONS: Grand Bazaar mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `SOSGrandBazaar_Data` or `SOSGrandBazaar_Data` in the archive.
...
Installs to: `SOSGrandBazaar_Data\Managed`
...
Installs to: `SOSGrandBazaar_Data`
