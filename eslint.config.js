  ...
  },
  {
    ...
    rules: {
      ...
      "no-restricted-properties": ["warn",
        ...
        { "object": "vfs", "property": "ensureDirSync", "message": "use fs.mkdirSync(p, { recursive: true })" },
        { "object": "vfs", "property": "ensureDirAsync", "message": "use fsp.mkdir(p, { recursive: true })" },
        { "object": "vfs", "property": "ensureFileAsync", "message": "use the injected ensureFileAsync() helper" },
        { "object": "vfs", "property": "removeAsync", "message": "use fsp.rm(p, { recursive: true, force: true })" },
        { "object": "vfs", "property": "copyAsync", "message": "use fsp.cp(s, d, { recursive: true })" },
        { "object": "vfs", "property": "copySync", "message": "use fs.cpSync(s, d, { recursive: true })" },
