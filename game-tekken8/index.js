...
const GAME_ID = "tekken8"; //same as Nexus domain
const STEAMAPP_ID = "1778820"; // https://steamdb.info/app/1778820/
const STEAMAPP_ID_DEMO = "2524440"; // https://steamdb.info/app/2524440/
...
const GAME_NAME_SHORT = "TEKKEN 8"; //Try for 8-10 characters
const EPIC_CODE_NAME = "Polaris"; //Folder in root
const EXEC = `TEKKEN 8.exe`; //DIFFERENT
...
const multiExe = true; //toggle for multiple executables (Epic/GOG/Demo don't match Steam)
...
//UE specific
const ENGINE_VERSION = "5.2.1.0"; //Unreal Engine version - info only atm. usually '4.27.2.0' or '5.X.X.0'
...
function applyGame(context, gameSpec) {
  ...
  /*if (ue4ssLoadOrder) { //disabled for this game - the LogicMods installer bifurcates pak mods away from the "~mods" folder and the load order
