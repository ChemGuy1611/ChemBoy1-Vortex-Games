# Notes for Mod Authors - Lords of the Fallen (2023)

Packaging rules for Lords of the Fallen (2023) mods, so Vortex installs them to the right place.
...
Installs to: `LOTF2\Content\Paks\LogicMods\LogicMods`
