...
const SAVE_PATH_XBOX = path.join(LOCALAPPDATA, "Packages", `${XBOXAPP_ID}_9609msxhzdsvj`, "SystemAppData", "wgs"); //XBOX Version
    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog('question', MESSAGE, {
            text: `${GAME_NAME} implements the Easy Anti-Cheat (EAC) anti-cheat engine to detect modified game files.\n`
