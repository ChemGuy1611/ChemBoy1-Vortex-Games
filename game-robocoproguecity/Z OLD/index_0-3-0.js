...
const SHIPPING_EXE = `${EPIC_CODE_NAME}\\Binaries\\${EXEC_FOLDER_NAME}\\RoboCop-${EXEC_FOLDER_NAME}-Shipping.exe`;
...
function applyGame(context, gameSpec) {
  ...
  context.registerInstaller(`${GAME_ID}-ue5`, 25, testUE5, installUE5);
