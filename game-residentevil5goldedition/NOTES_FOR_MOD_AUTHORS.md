# Notes for Mod Authors - Resident Evil 5 Gold Edition

Packaging rules for Resident Evil 5 Gold Edition mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `nativePC_MT`, `arc`, `data`, `effect` or `soft` in the archive.
