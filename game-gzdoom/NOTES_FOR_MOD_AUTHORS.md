...
| --- | --- | --- |
| Dml | - | - |
| Gzdoom | a file or folder named `uzdoom.exe` | - |
| Wad | a file or folder named one of: `doom.wad`, `doom2.wad`, `freedoom.wad` or `nerve.wad` and a file with one of these extensions: `.iwad` or `.ipk3` | - |
| Mod | a file with one of these extensions: `.wad`, `.pk3`, `.zip`, `.pak`, `.pk7`, `.grp`, `.rff`, `.deh`, `.iwad` or `.ipk3` | - |
| Zipmod | - | - |
