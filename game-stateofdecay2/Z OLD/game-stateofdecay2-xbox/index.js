/*
Name: State of Decay 2 Vortex Extension (XBOX Version)
...
const GAME_ID_XBOX = "stateofdecay2xbox";
...
const GAME_NAME = "State of Decay 2 (XBOX)";
...
const UNREALDATA = {
  ...
  absModsPath: path.join(process.env['LOCALAPPDATA'], XBOX_DATA_PATH, EPIC_CODE_NAME, 'Saved', 'Paks'), //XBOX Version
  fileExt: '.pak',
  loadOrder: true,
}
...
function applyGame(context, gameSpec) {
  ...
  context.registerInstaller(`${GAME_ID}-paks`, 35, testPak, installPak);
