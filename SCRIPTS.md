...
| `unity_top_level_functions(src)`                                                                    | Return the set of top-level function names declared in a Unity template/game `index.js` (`function name(...)` and `const name = (...) =>` forms, column 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `unity_bool_toggles(src)`                                                                           | Return the set of boolean toggle `const`/`let` names declared at column 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `unity_template_diff(src, template_folder_name)`                                                    | Return `(missing_functions, extra_functions, missing_toggles, extra_toggles)` for a Unity game's `index.js` against the named template's HEAD (`isXna` exempted both ways)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `has_unity_bepinex_parity(src, folder)`                                                             | Return `True` if a Unity+BepInEx extension has every function/toggle `template-unitybepinex` HEAD has, and is not on `UNITY_PARITY_KNOWN_EXCEPTIONS`. Extra functions/toggles beyond the template do not fail parity                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Mechanical layer for the template-parity audit: UE4-5 load-order parity plus Unity BepInEx/hybrid template parity. Regenerates the parity-related `resources/lists/` flag lists via `categorize_games.py`, then reports on games not yet at parity and a couple of invariants a stale or partial port can silently break.
