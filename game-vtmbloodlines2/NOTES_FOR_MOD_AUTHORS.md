# Notes for Mod Authors - Vampire: The Masquerade - Bloodlines 2

Packaging rules for Vampire: The Masquerade - Bloodlines 2 mods, so Vortex installs them to the right place.
...
| --- | --- | --- |
| Combo Mods (pak + UE4SS script/DLL together) | both a `Content` and a `Binaries` folder | `Bloodlines2` |
| Blueprint Mods (LogicMods) | a `LogicMods` folder | `Bloodlines2\Content\Paks\LogicMods\LogicMods` |
| Pak Mods | a `.pak` file | `Bloodlines2\Content\Paks\~mods` |
| UE4SS Itself | a `dwmapi.dll` file | `Bloodlines2\Binaries\Win64` |
| UE4SS Script Mods (Lua) | a `.lua` file and a `Scripts` folder | `Bloodlines2\Binaries\Win64\ue4ss\Mods` |
| UE4SS DLL Mods (C++) | a `.dll` file and a `dlls` folder | `Bloodlines2\Binaries\Win64\ue4ss\Mods` |
| Root / Game Folder Mods | a top-level folder such as `Bloodlines2` | the game folder itself (no subfolder) |
| Contentfolder | a file or folder named `Content` | `Bloodlines2` |
| Config File Mods | a config file such as `engine.ini` or `game.ini` | `CONFIGMOD_LOCATION\Bloodlines2` |
| Save Game Files | a `.sav` file | - |
| Fallback Installer | anything unrecognised with no pak file | `Bloodlines2\Binaries\Win64` |
...
Installs to: `Bloodlines2\Content\Paks\LogicMods\LogicMods`
...
Installs to: `Bloodlines2\Content\Paks\~mods`
...
Installs to: `Bloodlines2\Binaries\Win64`
...
Installs to: `Bloodlines2\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `Bloodlines2`.
...
- Installed to `CONFIGMOD_LOCATION\Bloodlines2`.

Installs to: `CONFIGMOD_LOCATION\Bloodlines2`
