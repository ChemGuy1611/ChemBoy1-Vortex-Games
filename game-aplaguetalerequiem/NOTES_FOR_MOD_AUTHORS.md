# Notes for Mod Authors - A Plague Tale Requiem

Packaging rules for A Plague Tale Requiem mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `DATAS`, `FONT`, `INPUT`, `LEVELS`, `RTC`, `Shaders`, `SOUNDBANKS`, `TRTEXT`, `UPDATE` or `VIDEOS` in the archive.
