# Notes for Mod Authors - Dead Rising Deluxe Remaster

Packaging rules for Dead Rising Deluxe Remaster mods, so Vortex installs them to the right place.
...
| Preset Files | a `.prt` file | `Games\DeadRisingRemaster\Presets` |
...
Installs to: `Games\DeadRisingRemaster\Presets`
