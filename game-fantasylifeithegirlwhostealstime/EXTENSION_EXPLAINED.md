...
| `collectionsLoadOrder` | `false` | include UE4SS and LogicMods load orders in collections (ANDed with the toggles above) |
...
| --- | --- |
| `fantasylifeithegirlwhostealstime-ue4sscombo` | 26 |
