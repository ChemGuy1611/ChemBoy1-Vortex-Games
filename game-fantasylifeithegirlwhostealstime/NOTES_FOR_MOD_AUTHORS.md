# Notes for Mod Authors - FANTASY LIFE i: The Girl Who Steals Time

Packaging rules for FANTASY LIFE i: The Girl Who Steals Time mods, so Vortex installs them to the right place.
...
- Recognised by a top-level folder matching any of: `Game`, `Engine`, `Content`, `Binaries` or `Mods`.
