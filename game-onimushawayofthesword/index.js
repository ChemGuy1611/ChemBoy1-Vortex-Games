...
const GAME_ID = "onimushawayofthesword";
const STEAMAPP_ID = "2638890"; // https://steamdb.info/app/2638890/
...
const GAME_NAME = "Onimusha: Way of the Sword";
...
const ROOT_EXTS = [".exe"];
const REF_PAGE_NO = 54;
const REF_FILE_NO = 107;
...
let hasXbox = true; //toggle for Xbox version logic - default true with new Capcom deal
