# Notes for Mod Authors - Monster Hunter Wilds

Packaging rules for Monster Hunter Wilds mods, so Vortex installs them to the right place.
...
Installs to: `Games\MonsterHunterWilds\Presets`
