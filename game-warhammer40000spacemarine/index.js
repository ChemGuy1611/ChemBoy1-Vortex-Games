...
const spec = {
  ...
  discovery: {
    ids: [STEAMAPP_ID, STEAMAPP_ID_MCE, EPICAPP_ID_MCE, GOGAPP_ID, GOGAPP_ID_MCE, XBOXAPP_ID_MCE],
    names: [],
  },
};
...
async function setup(discovery, api, gameSpec) {
  ...
  // ASYNC CODE //////////////////////////////////////////
  return vfs.ensureDirWritableAsync(path.join(GAME_PATH, PREVIEW_PATH));
}
