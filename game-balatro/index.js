...
const DATA_PATH_XBOX = path.join(
  LOCALAPPDATA,
  "Packages",
...
const XBOX_INSTALLER_URL =
  "https://codeberg.org/frostice482/balatro-xbgp/raw/branch/new/install.bat";
...
async function setup(discovery, api, gameSpec) {
  ...
  await vfs.ensureDirWritableAsync(MOD_PATH);
  await vfs.ensureDirWritableAsync(GAME_PATH);
