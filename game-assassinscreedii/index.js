...
const UPLAYAPP_ID = "4";
const STEAMAPP_ID = "33230";
const EPICAPP_ID = "d0ae8ca1b5c8421ca6ab892353d3204d";
const GAME_ID = "assassinscreedii";
const GAME_NAME = "Assassin's Creed II";
const GAME_NAME_SHORT = "AC II";
const EXEC = "AssassinsCreedIIGame.exe";
const ATK_ID = "assassinscreedii-atk";
...
async function setup(discovery, api, gameSpec) {
  ...
  await vfs.ensureDirWritableAsync(path.join(discovery.path, "scripts"));
