# Notes for Mod Authors - DRAGON QUEST I & II HD-2D Remake

Packaging rules for DRAGON QUEST I & II HD-2D Remake mods, so Vortex installs them to the right place.
...
| Pak Mods | a `.pak` file | `Game\Content\Paks` |
...
| Config File Mods | a config file such as `engine.ini` or `game.ini` | `CONFIGMOD_LOCATION\My Games\DRAGON QUEST I and II HD-2D Remake` |
...
Installs to: `Game\Content\Paks\LogicMods\LogicMods`
...
- Installed to `CONFIGMOD_LOCATION\My Games\DRAGON QUEST I and II HD-2D Remake`.

Installs to: `CONFIGMOD_LOCATION\My Games\DRAGON QUEST I and II HD-2D Remake`
