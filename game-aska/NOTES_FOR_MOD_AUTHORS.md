# Notes for Mod Authors - ASKA

Packaging rules for ASKA mods, so Vortex installs them to the right place.
...
| Asset Replacement Mods | a `.assets` file | `Aska_Data` |
