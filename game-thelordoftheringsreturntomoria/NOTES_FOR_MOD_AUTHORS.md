# Notes for Mod Authors - The Lord of the Rings: Return to Moria

Packaging rules for The Lord of the Rings: Return to Moria mods, so Vortex installs them to the right place.
...
Installs to: `Moria\Content\Paks\LogicMods`
...
Installs to: `Moria\Content\Paks\~mods`
...
Installs to: `Moria\Binaries\Win64`
...
Installs to: `Moria\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `Moria`, `Engine`, `Content`, `Binaries` or `Mods`.
