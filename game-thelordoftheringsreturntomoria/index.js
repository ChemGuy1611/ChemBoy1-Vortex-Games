...
const GAME_ID = "thelordoftheringsreturntomoria"; //same as Nexus domain
const STEAMAPP_ID = "2933130"; //from steamdb.info
const STEAMAPP_ID_DEMO = null; //VERIFY if the EPIC_CODE_NAME and EXEC_DEMO match Steam full game
const EPICAPP_ID = "8e4f8dc250364e30aef276555bba1734"; //from egdata.app
...
const GAME_NAME = "The Lord of the Rings: Return to Moria";
const GAME_NAME_SHORT = "LoTR: Return to Moria"; //Try for 8-10 characters
const EPIC_CODE_NAME = "Moria"; //Folder in root
...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/The_Lord_of_the_Rings:_Return_to_Moria";
...
const SAVE_PATH_EPIC = path.join(SAVEMOD_LOCATION, DATA_FOLDER, "Saved", "SaveGamesEpic"); //no easy way to differentiate Epic version
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1635"; //Nexus link to this extension. Used for links
const spec = {
  game: {
    id: GAME_ID,
    name: GAME_NAME,
...
function checkPartitions(folder, discoveryPath) {
  if (!preferHardlinks) {
    //only do early return if hardlinks have no benefits
    if (!IO_STORE) {
