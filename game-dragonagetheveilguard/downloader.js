...
// '0.0.0' floor.
//   1. Already valid semver -> take it as authored, prerelease identifier and all. That keeps a
//      real prerelease alive (a fork tagging 3.1.0-6, where -6 is a prerelease and not a fourth
//      segment), and it also shields a genuine 3-segment tag from normalizeFrostyVersion below,
//      whose unconditional .pop() would otherwise turn 1.2.3 into 1.2.
...
//      5.4.23.x bump used to compare equal too. Frosty dates never reach this rule -
//      normalizeFrostyVersion already dropped their build segment - which is why it runs first.
//   3. Anything else -> normalizeFrostyVersion + coerce, the original behavior, which also keeps
//      the loose 19.0 -> 19.0.0 widening.
