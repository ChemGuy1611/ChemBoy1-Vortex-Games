/*////////////////////////////////////////////////
Name: STAR WARS Zero Company Vortex Extension
...
const GAME_ID = "starwarszerocompany"; //same as Nexus domain
const STEAMAPP_ID = "2075800"; // https://steamdb.info/app/2075800/
const STEAMAPP_ID_DEMO = null; //VERIFY if the EPIC_CODE_NAME and EXEC_DEMO match Steam full game
const EPICAPP_ID = "bruno"; // https://store.epicgames.com/en-US/p/star-wars-zero-company-21b5c6
...
const GAME_NAME = "STAR WARS Zero Company";
const GAME_NAME_SHORT = "STAR WARS Zero Company"; //Try for 8-10 characters
const EPIC_CODE_NAME = "SWZeroCompany"; //Folder in root
...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Star_Wars%3A_Zero_Company";
...
const UE4SS_PAGE_NO = 9; //set these if there is a customized UE4SS Nexus page
const UE4SS_FILE_NO = 6;
