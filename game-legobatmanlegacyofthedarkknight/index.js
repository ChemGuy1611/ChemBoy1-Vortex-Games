...
const GAME_ID = "legobatmanlegacyofthedarkknight"; //same as Nexus domain
const STEAMAPP_ID = "2215200"; // https://steamdb.info/app/2215200/
const STEAMAPP_ID_DEMO = null; //VERIFY if the EPIC_CODE_NAME and EXEC_DEMO match Steam full game
const EPICAPP_ID = "b111ac9d19e147c2a4a7073c8e7623c8"; // https://store.epicgames.com/en-US/p/lego-batman-legacy-of-the-dark-knight-c82b6b
...
const GAME_NAME = "LEGO Batman: Legacy of the Dark Knight";
const GAME_NAME_SHORT = "LEGO Batman"; //Try for 8-10 characters
const EPIC_CODE_NAME = "LEGOBatmanLotDK"; //Folder in root
...
const UE4SS_PAGE_NO = 5; //set these if there is a customized UE4SS Nexus page
...
//config and save
const DATA_FOLDER = "Dinner"; //!different
