# Notes for Mod Authors - Resident Evil Requiem

Packaging rules for Resident Evil Requiem mods, so Vortex installs them to the right place.
...
- Recognised by any file named `nvngx_dlss.dll`, `sl.dlss.dll`, `libxess.dll`, `dstoragecore.dll`, `dstorage.dll`, `amd_fidelityfx_dx12.dll`, `amd_fidelityfx_loader_dx12.dll` or `amd_ags_x64.dll`.
