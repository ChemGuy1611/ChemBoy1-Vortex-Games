# Notes for Mod Authors - S.T.A.L.K.E.R. 2: Heart of Chornobyl

Packaging rules for S.T.A.L.K.E.R. 2: Heart of Chornobyl mods, so Vortex installs them to the right place.
...
Recognised when the archive contains a file or folder named `simple_mod_merger.exe`.

Installs to: `Stalker2SimpleModMerger`
...
Installs to: `Stalker2\Content\Paks\LogicMods\LogicMods`
