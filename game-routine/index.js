...
const GAME_ID = "routine"; //same as Nexus domain
const STEAMAPP_ID = "606160"; //from steamdb.info
const STEAMAPP_ID_DEMO = null;
const EPICAPP_ID = null; //from egdata.app
const GOGAPP_ID = null; // from gogdb.org
const XBOXAPP_ID = "RawFury.ROUTINE"; //from appxmanifest.xml
...
const GAME_NAME = "ROUTINE";
const GAME_NAME_SHORT = "ROUTINE"; //Try for 8-10 characters
const EXEC = "Routine.exe";
const EXEC_EPIC = EXEC;
const EXEC_GOG = EXEC;
const EXEC_DEMO = EXEC;
const EXEC_XBOX = "gamelaunchhelper.exe";
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Routine";
...
const XBOX_SAVE_STRING = "9s0pnehqffj7t"; //'8wekyb3d8bbwe' if published by Microsoft
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1575"; //Nexus link to this extension. Used for links
const spec = {
  game: {
    id: GAME_ID,
    name: GAME_NAME,
