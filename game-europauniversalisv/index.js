...
const GAME_ID = "europauniversalisv";
const STEAMAPP_ID = "3450310";
...
const GAME_NAME = "Europa Universalis V";
const GAME_NAME_SHORT = "Europa Univ V";
const BINARIES_PATH = path.join('binaries');
const EXEC_NAME = "eu5.exe";
const EXEC = path.join(BINARIES_PATH, EXEC_NAME);
const EXEC_EGS = EXEC;
const EXEC_XBOX = 'gamelaunchhelper.exe';

const ROOT_FOLDERS = ['game', 'binaries'];
//can't install against these folders in game directory because they will be present in mod archives
const DATASUB_FOLDERS = ['dlc', 'in_game', 'decisions', 'dlc_metadata', 'events', 'gfx', 'history', 'hints', 'interface', 'localisation', 'map', 'missions', 'music', 'sound', 'soundtrack', 'tests', 'tutorial', 'tweakergui_assets'];

const DATA_FOLDER = path.join('Paradox Interactive', 'Europa Universalis V');
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1524"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Europa_Universalis_V";
const spec = {
  "game": {
    "id": GAME_ID,
    "name": GAME_NAME,
