...
const GAME_ID = "watchdogslegion";
const STEAMAPP_ID = "2239550"; // https://steamdb.info/app/2239550/
const UPLAYAPP_ID = "3353";
const EPICAPP_ID = "Hawk"; // https://store.epicgames.com/en-US/p/watch-dogs-legion
...
const GAME_NAME = "Watch Dogs: Legion";
const GAME_NAME_SHORT = "Watch Dogs: Legion";
...
const APPDATA_FOLDER = path.join('My Games', 'Watch Dogs Legion');
...
const MOD_NAME = "Mod";
const MOD_PATH = path.join(LOADER_PATH, 'Watch Dogs Legion');
...
let USERID_FOLDER = "";
let SAVE_PATH = ''; //Defined in setup fn <Ubisoft-Connect-folder>\savegames\<user-id>\3353\
...
const CONFIG_FILES = ["WD3_GamerProfile.xml"];
