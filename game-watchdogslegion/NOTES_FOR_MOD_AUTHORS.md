# Notes for Mod Authors - Watch Dogs: Legion

Packaging rules for Watch Dogs: Legion mods, so Vortex installs them to the right place.
...
Installs to: `Disrupt_Manager\Watch Dogs Legion`
