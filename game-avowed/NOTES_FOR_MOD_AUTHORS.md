# Notes for Mod Authors - Avowed

Packaging rules for Avowed mods, so Vortex installs them to the right place.
...
Installs to: `Alabama\Content\Paks\LogicMods\LogicMods`
...
Installs to: `Alabama\Content\Paks\~mods`
...
- Recognised by a top-level folder matching any of: `Alabama`.
