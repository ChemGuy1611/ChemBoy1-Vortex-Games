# Notes for Mod Authors - template-tfcinstaller-ue2-3 (template)

Packaging rules for template-tfcinstaller-ue2-3 (template) mods, so Vortex installs them to the right place.
