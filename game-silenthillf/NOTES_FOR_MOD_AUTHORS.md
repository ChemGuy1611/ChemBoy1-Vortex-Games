# Notes for Mod Authors - Silent Hill f

Packaging rules for Silent Hill f mods, so Vortex installs them to the right place.
...
Installs to: `SHf\Content\Paks\LogicMods\LogicMods`
...
Installs to: `SHf\Content\Paks\~mods`
...
Installs to: `SHf\Binaries\Win64`
...
Installs to: `SHf\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `SHf`.
...
- Installed to `CONFIGMOD_LOCATION\SHf\Saved\Config\Windows`.

Installs to: `CONFIGMOD_LOCATION\SHf\Saved\Config\Windows`
