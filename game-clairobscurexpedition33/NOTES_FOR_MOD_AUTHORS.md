# Notes for Mod Authors - Clair Obscur: Expedition 33

Packaging rules for Clair Obscur: Expedition 33 mods, so Vortex installs them to the right place.
...
Installs to: `Sandfall\Content\Paks\LogicMods\LogicMods`
