...
| Executable (Demo) | `Expedition33_Steam.exe` |
...
| Paks (no "~mods") | `clairobscurexpedition33-pakalt` | high | `{gamePath}/Sandfall/Content/Paks` |
| Root Folder | `clairobscurexpedition33-root` | high | `{gamePath}` |
| Content Folder | `clairobscurexpedition33-contentfolder` | high | `{gamePath}/Sandfall` |
| UE Sortable Pak Mod | `clairobscurexpedition33-ue5-sortable-modtype` | 25 | `?` |
...
| Config (Local AppData) | `clairobscurexpedition33-config` | 62 | `?` |
| Saves (Local AppData) | `clairobscurexpedition33-save` | 64 | `?` |
...
| --- | --- |
| `clairobscurexpedition33-ue4sscombo` | 26 |
| `clairobscurexpedition33-logicmods` | 27 |
| `clairobscurexpedition33-ue5-sortable-modtype` | 29 |
| `clairobscurexpedition33-ue4ss` | 31 |
| `clairobscurexpedition33-scripts` | 35 |
| `clairobscurexpedition33-ue4ssdll` | 37 |
| `clairobscurexpedition33-contentfolder` | 38 |
| `clairobscurexpedition33-root` | 39 |
| `clairobscurexpedition33-config` | 41 |
| `clairobscurexpedition33-save` | 43 |
| `clairobscurexpedition33-binaries` | 49 |
