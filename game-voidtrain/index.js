...
const GAME_ID = "voidtrain"; //same as Nexus domain
const STEAMAPP_ID = "1159690"; //from steamdb.info
const STEAMAPP_ID_DEMO = "1321660";
const EPICAPP_ID = "a0c3344c008d4475a9a29a7a0b6189b8"; //from egdata.app
const GOGAPP_ID = null; // from gogdb.org
const XBOXAPP_ID = "HypeTrainDigital.VoidTrain"; //from appxmanifest.xml
const XBOXEXECNAME = "AppVoidTrainShipping"; //from appxmanifest.xml
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, XBOXAPP_ID, EPICAPP_ID, STEAMAPP_ID_DEMO]; // UPDATE THIS WITH ALL VALID IDs
const GAME_NAME = "Voidtrain";
const GAME_NAME_SHORT = "Voidtrain"; //Try for 8-10 characters
const EXEC = "VoidTrain.exe";
...
const EPIC_CODE_NAME = "VoidTrain";
...
const XBOX_SAVE_STRING = "7t701d8q7nf00"; //'8wekyb3d8bbwe' if published by Microsoft
