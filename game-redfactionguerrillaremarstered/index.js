...
const spec = {
  ...
  discovery: {
    ids: [STEAMAPP_ID, GOGAPP_ID, STEAMAPP_ID_LEGACY],
    names: [],
  },
};
    ...
    actions: [
      {
        ...
        action: (dismiss) => {
          api.showDialog(
            "question",
            "Mod Manager Must Be Run",
            {
              text:
                "The Mod Manager tool downloaded by this extension must be run every time new mods are installed.\n" +
