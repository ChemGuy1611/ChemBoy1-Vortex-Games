# Notes for Mod Authors - FINAL FANTASY TACTICS - The Ivalice Chronicles

Packaging rules for FINAL FANTASY TACTICS - The Ivalice Chronicles mods, so Vortex installs them to the right place.
...
Recognised when the archive contains a file or folder named `modconfig.json` and a file or folder named `fftivc.utility.modloader.dll`.

Installs to: `Reloaded\Mods\FFTIVC_Mod_Loader`
