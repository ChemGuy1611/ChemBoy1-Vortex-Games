# The Lord of the Rings: War in the North - Legacy Edition — Vortex Extension Explained
...
| Property | Value |
| --- | --- |
| Game ID | `lotrwarinthenorthle` |
| Executable | `witn.exe` |
| Executable (Xbox) | `gamelaunchhelper.exe` |
| Executable (GOG) | `witn.exe` |
| Executable (Demo) | `witn.exe` |
| Extension Page | [https://www.nexusmods.com/site/mods/2214](https://www.nexusmods.com/site/mods/2214) |
| PCGamingWiki | [https://www.pcgamingwiki.com/wiki/The_Lord_of_the_Rings%3A_War_in_the_North_-_Legacy_Edition](https://www.pcgamingwiki.com/wiki/The_Lord_of_the_Rings%3A_War_in_the_North_-_Legacy_Edition) |
...
| --- | --- | --- | --- |
| Root Folder | `lotrwarinthenorthle-root` | high | `{gamePath}` |
...
| --- | --- |
| `lotrwarinthenorthle-root` | 27 |
| `lotrwarinthenorthle-fallback` | 49 |

## Registered Tools

These tools appear in Vortex's Tools panel when this game is active:

- **Custom Launch** (`witn.exe`)
