# Notes for Mod Authors - Windrose

Packaging rules for Windrose mods, so Vortex installs them to the right place.
...
Installs to: `R5\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `R5`, `Engine`, `Content`, `Binaries` or `Mods`.
...
- Recognised by any file with extension `.sst`.
