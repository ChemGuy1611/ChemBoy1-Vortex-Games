...
const GAME_ID = "octopathtraveler0"; //same as Nexus domain
const STEAMAPP_ID = "3014320"; //from steamdb.info
const STEAMAPP_ID_DEMO = "3014330";
const EPICAPP_ID = null; //from egdata.app
const GOGAPP_ID = null; // from gogdb.org
const XBOXAPP_ID = "39EA002F.Octr0"; // THIS IS A GUESS based on the demo manifest
const XBOXAPP_ID_DEMO = "39EA002F.Octr0DEMO"; //from appxmanifest.xml
const XBOXEXECNAME = "AppOctopathTraveler0Shipping"; //from appxmanifest.xml
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, XBOXAPP_ID, STEAMAPP_ID_DEMO, XBOXAPP_ID_DEMO]; // UPDATE THIS WITH ALL VALID IDs
const GAME_NAME = "OCTOPATH TRAVELER 0";
const GAME_NAME_SHORT = "OCTOPATH TRAVELER 0"; //Try for 8-10 characters
const EXEC = "Octopath_Traveler0.exe";
const EXEC_EPIC = EXEC;
const EXEC_GOG = EXEC;
const EXEC_DEMO = EXEC;
const EXEC_XBOX = "gamelaunchhelper.exe";
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Octopath_Traveler_0";
...
const EPIC_CODE_NAME = "Octopath_Traveler0";
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1566"; //Nexus link to this extension. Used for links
const spec = {
  game: {
    id: GAME_ID,
    name: GAME_NAME,
