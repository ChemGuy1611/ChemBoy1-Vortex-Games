...
const UPLAYAPP_ID = ""; //Could also be 
const STEAMAPP_ID = "48190";
const GAME_ID = "assassinscreedbrotherhood";
const GAME_NAME = "Assassin's Creed Brotherhood";
const GAME_NAME_SHORT = "AC Brotherhood";
const EXEC = "ACBSP.exe";
const ATK_ID = `${GAME_ID}-atk`;
const ATK_EXEC = 'anviltoolkit.exe';

const EXTENSION_URL = "https://www.nexusmods.com/site/mods/989"; //Nexus link to this extension. Used for links
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Assassin%27s_Creed%3A_Brotherhood";
