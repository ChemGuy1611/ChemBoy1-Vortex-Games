...
const EPICAPP_ID = "05153d489e6843a1b5b53363280cb141"; //!audit-skip: store-id - not added to discovery yet because this Epic version does not have a top-level "Windows" folder
...
*/
const UNREALDATA = {
  modsPath: path.join("Windows", EPIC_CODE_NAME, "Content", "Paks", "~mods"),
...
const UE5_ALT_PATH = path.join("Windows", EPIC_CODE_NAME, "Content", "Paks");
...
const LOGICMODS_PATH = path.join("Windows", EPIC_CODE_NAME, "Content", "Paks", "LogicMods");
...
const PCGAMINGWIKI_URL = "https://www.pcgamingwiki.com/wiki/Until_Dawn";
