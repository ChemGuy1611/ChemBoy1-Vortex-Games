# Notes for Mod Authors - Until Dawn

Packaging rules for Until Dawn mods, so Vortex installs them to the right place.
...
Installs to: `Windows\Bates\Content\Paks\LogicMods\LogicMods`
...
Installs to: `Windows\Bates\Content\Paks\~mods`
...
Installs to: `Windows\Bates\Binaries\Win64`
...
Installs to: `Windows\Bates\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `Bates`.
