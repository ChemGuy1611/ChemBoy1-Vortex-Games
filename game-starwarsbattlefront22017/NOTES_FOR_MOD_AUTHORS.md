# Notes for Mod Authors - STAR WARS Battlefront II

Packaging rules for STAR WARS Battlefront II mods, so Vortex installs them to the right place.
...
Installs to: `FrostyModManager\Mods\StarWarsBattlefrontII`
