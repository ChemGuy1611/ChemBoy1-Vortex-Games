...
const GAME_ID = "ballxpit";
const STEAMAPP_ID = "2062430";
const STEAMAPP_ID_DEMO = "3651790";
const EPICAPP_ID = null;
const GOGAPP_ID = null;
const XBOXAPP_ID = "DevolverDigital.BallxPit";
const XBOXEXECNAME = "Game";
const XBOX_PUB_ID = "6kzv4j18v0c96"; //string after "ID_"
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, XBOXAPP_ID, STEAMAPP_ID_DEMO]; // UPDATE THIS WITH ALL VALID IDs

const GAME_NAME = "BALL x PIT";
const GAME_NAME_SHORT = "BALL x PIT";
...
const DATA_FOLDER_ALT = "BALL x PIT_Data"; //Xbox data folder name doesn't match GAME_STRING
...
const SAVE_FOLDERNAME = ""; //no extra subfolder - saves sit directly under LocalLow\DEV_REGSTRING\GAME_REGSTRING
...
const REQ_FILE = path.join(ASSEMBLY_PATH, ASSEMBLY_FILES[0]);
