# Notes for Mod Authors - Bellwright

Packaging rules for Bellwright mods, so Vortex installs them to the right place.
...
Installs to: `Bellwright\Content\Paks\LogicMods\LogicMods`
...
Installs to: `Bellwright\Content\Mods`
...
Installs to: `Bellwright\Binaries\Win64`
...
Installs to: `Bellwright\Binaries\Win64\Mods`
...
- Recognised by a top-level folder matching any of: `Bellwright`.
