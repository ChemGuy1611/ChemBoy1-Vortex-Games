# Notes for Mod Authors - MechWarrior 5: Clans

Packaging rules for MechWarrior 5: Clans mods, so Vortex installs them to the right place.
...
Recognised when the archive contains a file or folder named `mod.json` and a file with the `.uplugin` extension.

Installs to: `MW5Clans\Mods`
...
Installs to: `MW5Clans\Content\Paks\LogicMods\LogicMods`
...
Installs to: `MW5Clans\Content\Paks\~mods`
...
- Recognised by a top-level folder matching any of: `MW5Clans`.
