...
const GAME_ID = "mechwarrior5clans";
const STEAMAPP_ID = "2000890";
const EPICAPP_ID = "d97001f0a24b46afa65b42b2ceb5f1bc";
const GOGAPP_ID = null;
const XBOXAPP_ID = "PiranhaGamesInc.MechWarrior5Clans";
const XBOXEXECNAME = "AppMechWarrior5ClansShipping";
const EPIC_CODE_NAME = "MW5Clans";
const GAME_NAME = "MechWarrior 5: Clans";
const GAME_NAME_SHORT = "MechWarrior 5: Clans";
const DEFAULT_EXEC = "MechWarrior.exe";
...
//const SAVE_PATH_XBOX = path.join(LOCALAPPDATA, "Packages", `${XBOXAPP_ID}_8wekyb3d8bbwe`, "SystemAppData", "wgs", USER_ID); //XBOX Version
...
//const GOG_EXEC = `MechWarrior.exe`;
//const EPIC_EXEC = `MechWarrior.exe`;
...
function testConfig(files, gameId) {
  const isConfig =
    files.find((file) => CONFIG_FILES.includes(path.basename(file).toLowerCase())) !== undefined;
...
async function setup(discovery, api, gameSpec) {
  ...
  return vfs.ensureDirWritableAsync(path.join(discovery.path, EDITORMOD_PATH));
}
