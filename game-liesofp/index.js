...
const GAME_ID = "liesofp"; //same as Nexus domain
const STEAMAPP_ID = "1627720"; //from steamdb.info
const STEAMAPP_ID_DEMO = null; //no demo
const EPICAPP_ID = "414c01a544a84928be40c1e86e0fd169"; //from egdata.app
const GOGAPP_ID = null; // from gogdb.org
const XBOXAPP_ID = "Neowiz.3616725F496B"; //from appxmanifest.xml
const XBOXEXECNAME = "AppLiesofPShipping"; //from appxmanifest.xml
const XBOX_PUB_ID = "r4z3116tdh636"; //recovered from the old file's live Save folder path, not a guess
const DISCOVERY_IDS_ACTIVE = [STEAMAPP_ID, EPICAPP_ID, XBOXAPP_ID]; // UPDATE THIS WITH ALL VALID IDs

const GAME_NAME = "Lies of P";
const GAME_NAME_SHORT = "Lies of P"; //Try for 8-10 characters
const EPIC_CODE_NAME = "LiesofP"; //Folder in root
const EXEC = `LOP.exe`; //This is true ~80% of the time. Change if different
...
const SAVE_EXTS = [".sav"];
const SAVE_COMPAT_VERSIONS = ["steam", "epic"]; //game versions with installable save mods (never Xbox)
...
async function resolveGameVersion(gamePath, exePath) {
  ...
  //No confirmed "-Shipping.exe" naming for this game (old file read version straight off EXEC) -
  //getShippingExe()/getBinariesFolder() stay unwired dead code, same status as game-trepang2.
