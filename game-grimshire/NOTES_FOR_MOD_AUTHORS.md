# Notes for Mod Authors - Grimshire

Packaging rules for Grimshire mods, so Vortex installs them to the right place.
...
- Recognised by a folder named `Grimshire_Data` or `Grimshire_Data` in the archive.
