# Notes for Mod Authors - METAL EDEN

Packaging rules for METAL EDEN mods, so Vortex installs them to the right place.
...
Installs to: `MetalEden\Content\Paks\LogicMods\LogicMods`
...
Installs to: `MetalEden\Content\Paks\~mods`
...
Installs to: `MetalEden\Binaries\Win64`
...
Installs to: `MetalEden\Binaries\Win64\ue4ss\Mods`
...
- Recognised by a top-level folder matching any of: `MetalEden`.
...
- Installed to `CONFIGMOD_LOCATION\MetalEden\Saved\Config\Windows`.

Installs to: `CONFIGMOD_LOCATION\MetalEden\Saved\Config\Windows`
