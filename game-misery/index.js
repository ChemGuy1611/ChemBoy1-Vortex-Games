...
const GAME_ID = "misery"; //same as Nexus domain
const STEAMAPP_ID = "2119830"; // https://steamdb.info/app/2119830/
...
const GAME_NAME = "MISERY";
const GAME_NAME_SHORT = "MISERY"; //Try for 8-10 characters
const EPIC_CODE_NAME = "MISERY"; //Folder in root
...
const EXTENSION_URL = "https://www.nexusmods.com/site/mods/1795"; //Nexus link to this extension. Used for links
...
const UE4SS_PAGE_NO = 2; //2 - not used since it doesn't have any custom config and is outdated
const UE4SS_FILE_NO = 7;
